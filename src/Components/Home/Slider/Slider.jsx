...
import "./Slider.css";
import sliderImgOne from "../../../assets/images/heroImage.png";
import sliderImgTwo from "../../../assets/images/heroImage2.png";
              ...
              <div className="w-full flex-shrink-0 relative">
                <div className="absolute inset-0 flex flex-col items-start justify-center text-white bg-white/80 md:bg-transparent">
                  <div className="w-full md:max-w-[450px] p-4">
                    ...
                    <h5 className="text-base md:text-lg mb-4 text-white details">
